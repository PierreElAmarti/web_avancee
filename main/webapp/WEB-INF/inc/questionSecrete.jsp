...
<body>
	<div class="form-group">
	    ...
	    <select name="questionSecrete" class="form-select">
	  		<option selected value="0">Dans quelle ville êtes-vous né(e) ?</option>
	  		<option value="1">Quel est le premier concert auquel vous avez assisté ?</option>
	  		<option value="2">Quels étaient le fabricant et le modèle de votre première voiture ?</option>
	  		<option value="3">Dans quelle ville vos parents se sont-ils rencontrés ?</option>

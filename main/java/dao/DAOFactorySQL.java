...
public class DAOFactorySQL implements DAOFactory
{
	...
	public DAOFactorySQL(String url, String username, String password)
	{
		super();
		this.url = url;
	 ...
	 */
	public static DAOFactorySQL getInstance() throws DAOConfigurationException
	{
		...
		DAOFactorySQL instance = new DAOFactorySQL(url, nomUtilisateur, motDePasse);
		return instance;
	}
	...
	{
		return new UtilisateurDaoSQL(this);
	}
